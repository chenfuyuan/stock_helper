...
async def test_run_concept_sync_success(
    ...
    with patch(
        "src.modules.data_engineering.application.services.basic_data_sync_service.DataEngineeringContainer"
    ) as mock_container_class:
        with patch(
            "src.modules.data_engineering.application.services.basic_data_sync_service.SyncConceptDataCmd"
        ) as mock_cmd_class:
            # 模拟容器
...
async def test_run_stock_basic_sync_success(
    ...
    with patch(
        "src.modules.data_engineering.application.services.basic_data_sync_service.SyncUseCaseFactory"
