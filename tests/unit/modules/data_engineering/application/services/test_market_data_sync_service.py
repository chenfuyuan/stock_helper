...
async def test_run_sync_with_target_date(
    ...
    with patch(
        "src.modules.data_engineering.application.services.market_data_sync_service.DataEngineeringContainer"
...
async def test_run_sync_without_target_date(
    ...
    with patch(
        ...
        # 模拟当前日期
        with patch(
            "src.modules.data_engineering.application.services.market_data_sync_service.datetime"
