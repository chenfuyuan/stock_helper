...
def test_graham_number_calculated_correctly():
    ...
    finances = [_make_finance_record(date(2024, 9, 30), eps=2.0, bps=16.0)]
...
def test_graham_na_when_eps_zero():
    ...
    finances = [_make_finance_record(date(2024, 9, 30), eps=0.0, bps=16.0)]
...
def test_graham_na_when_bps_negative():
    ...
    finances = [_make_finance_record(date(2024, 9, 30), eps=2.0, bps=-5.0)]
...
def test_roe_from_roe_waa():
    ...
    finances = [_make_finance_record(date(2024, 9, 30), roe_waa=18.5)]
