---
title: Debate Module Specification
version: 1.0
...
capabilities:
  - bull-bear-engine
source_specs:
  - debate-bull-bear-engine
---

# Debate Module Specification

## Purpose

Debate 模块负责多空博弈,基于研报进行红蓝军对抗,识别风险点,生成辩论纪要。作为业务核心模块,它接收五专家研究结果,通过 LLM 驱动的三阶段结构化辩论流程(多头论证 → 空头论证 → 交叉质疑与冲突消解),输出综合方向、置信度、多空论点摘要、风险矩阵、冲突消解结论。Debate 只做辩论与风控,不做数据采集、研究或最终投资决策。

**核心职责**:
- 编排三阶段辩论流程(Bull Advocate、Bear Advocate、Resolution Judge)
- 生成多头与空头论证
- 进行交叉质疑与冲突消解
- 输出辩论结果与风险矩阵
...
|------------|-------------|--------|
| bull-bear-engine | 多空辩论引擎核心能力 | debate-bull-bear-engine |
...
## capability: bull-bear-engine

> Source: debate-bull-bear-engine/spec.md (archived)
