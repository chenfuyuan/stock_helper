---
title: Valuation Modeler Specification
version: 1.0
...
capabilities:
  - valuation-modeling
source_specs:
  - research-valuation-modeler
---

# Valuation Modeler Specification
...
|------------|-------------|--------|
| valuation-modeling | 估值模型计算与判断 | research-valuation-modeler/spec.md |
...
## capability: valuation-modeling

> Source: research-valuation-modeler/spec.md

估值建模师能力：基于基本面数据与预计算估值模型，计算标的的「内在价值」与「安全边际」。
