---
title: Technical Analyst Specification
version: 1.0
...
# Technical Analyst Specification
...
|------------|-------------|--------|
| technical-analysis | 技术指标分析与观点生成 | research-technical-analyst/spec.md |
...
> Source: research-technical-analyst/spec.md

技术分析师能力：将预计算的技术指标与形态整合为证据驱动的技术面观点（结构化 JSON），供 Debate/Judge 使用。
