---
title: Judge Module Specification
version: 1.0
...
# Judge Module Specification

## Purpose

Judge 模块核心能力：接收辩论结果，通过 LLM 驱动的单次综合裁决流程，输出结构化的投资决策。Judge 只做综合裁决与风控约束，不做研报、辩论流程或数据采集。

**核心职责**：
- 接收辩论结果并进行综合裁决
- 输出操作方向、仓位建议、入场策略、止损止盈等结构化决策
- 提供风控约束和裁决理由
...
|------------|-------------|--------|
| verdict-engine | 裁决引擎核心能力 | judge-verdict-engine |
...
> Source: judge-verdict-engine/spec.md (archived)
