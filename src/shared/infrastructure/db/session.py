...
async def get_db_session() -> AsyncSession:
    ...
    async with AsyncSessionLocal() as session:
        try:
            ...
            from src.shared.domain.exceptions import BadRequestException, NotFoundException, UnauthorizedException, ForbiddenException
            ...
            elif isinstance(e, (BadRequestException, NotFoundException, UnauthorizedException, ForbiddenException)):
                is_client_error = True
