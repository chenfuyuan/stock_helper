...
from src.modules.research.domain.ports.macro_context_builder import IMacroContextBuilder
...
class MacroContextBuilderImpl(IMacroContextBuilder):
    ...
    def _normalize_dimension_name(self, dimension_topic: str) -> str:
        ...
        if "货币" in topic_lower or "流动性" in topic_lower:
            ...
            return "产业政策"
        elif "宏观" in topic_lower or "经济" in topic_lower or "gdp" in topic_lower or "pmi" in topic_lower:
            return "宏观经济"
