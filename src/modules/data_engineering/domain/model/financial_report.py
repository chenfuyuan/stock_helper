...
class StockFinance(BaseEntity):
    ...
    salescash_to_or: Optional[float] = Field(None, description="销售商品提供劳务收到的现金/营业收入")
    ocf_to_or: Optional[float] = Field(None, description="经营活动产生的现金流量净额/营业收入")
    ocf_to_opincome: Optional[float] = Field(None, description="经营活动产生的现金流量净额/经营活动净收益")
    ...
    eqt_to_talcapital: Optional[float] = Field(None, description="归属于母公司的股东权益/全部投入资本")
    ...
    ocf_to_shortdebt: Optional[float] = Field(None, description="经营活动产生的现金流量净额/流动负债")
