...
class BrokenBoardModel(Base):
    """
    炸板池数据库模型
    映射 de_broken_board_pool 表
    """

    __tablename__ = "de_broken_board_pool"
    ...
    open_count = Column(Integer, nullable=False, comment="开板次数")
    first_limit_up_time = Column(String(20), nullable=True, comment="首次封板时间")
    last_open_time = Column(String(20), nullable=True, comment="最后开板时间")
    ...
    __table_args__ = (UniqueConstraint("trade_date", "third_code", name="uq_broken_board"),)
