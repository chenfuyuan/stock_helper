...
class StockModel(Base):
    ...
    third_code = Column(String(20), unique=True, nullable=False, index=True, comment="第三方代码")
    ...
    list_status = Column(String(10), nullable=True, comment="上市状态 L上市 D退市 P暂停上市")
    delist_date = Column(Date, nullable=True, comment="退市日期")
    is_hs = Column(String(10), nullable=True, comment="是否沪深港通标的，N否 H沪股通 S深股通")
